...
function gerarTabela(url){
    ...
    .then((alunos)=>{
        ...
        for(var i = 0; i < qtdeLinhas; i++){
            ...
            //2a coluna
            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.nome1);
            td.appendChild(txt);
            tr.appendChild(td);

            //3a coluna
            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.nome2);
            td.appendChild(txt);
            tr.appendChild(td);

            //4a
            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.nome3);
            td.appendChild(txt);
            tr.appendChild(td);

            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.nome4);
            td.appendChild(txt);
            tr.appendChild(td);

            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.nome5);
            td.appendChild(txt);
            tr.appendChild(td);
