...
var main = document.getElementById('frequencia');
...
function gerarTabela(url){
    ...
    .then((alunos)=>{
        ...
        for(var i = 0; i < qtdeLinhas; i++){
            ...
            //2a coluna
            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.frequencia1);
            td.appendChild(txt);
            tr.appendChild(td);

            //3a coluna
            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.frequencia2);
            td.appendChild(txt);
            tr.appendChild(td);

            //4a
            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.frequencia3);
            td.appendChild(txt);
            tr.appendChild(td);

            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.frequencia4);
            td.appendChild(txt);
            tr.appendChild(td);

            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.frequencia5);
            td.appendChild(txt);
            tr.appendChild(td);
