...
var main = document.getElementById('atividade');
...
function gerarTabela(url){
    ...
    .then((alunos)=>{
        ...
        var frequencia = document.getElementById('atividade');
        ...
        for(var i = 0; i < qtdeLinhas; i++){
            ...
            //2a coluna
            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.atividade);
            td.appendChild(txt);
            tr.appendChild(td);

            //3a coluna
            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.professor);
            td.appendChild(txt);
            tr.appendChild(td);

            //4a
            var td = document.createElement('td');
            var txt = document.createTextNode(aluno.estado);
            td.appendChild(txt);
            tr.appendChild(td);
